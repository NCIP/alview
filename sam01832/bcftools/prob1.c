...
int bcf_p1_set_n1(bcf_p1aux_t *b, int n1)
{
	...
	if (b->M != b->n * 2) {
		fprintf(stderr, "unable to set `n1' when there are haploid samples.\n");
		return -1;
	}
	b->n1 = n1;
	return 0;
...
double chi2_test(int a, int b, int c, int d)
{
	double x, z;
...
double contrast2_aux(const bcf_p1aux_t *p1, double sum, int k1, int k2, double x[3])
{
...
double contrast2(bcf_p1aux_t *p1, double ret[3])
{
